...
public class FillHarvestingForm {
    ...
    public static void main(String[] args) {
        try {
            ...
            addSpecimen.click();
            System.out.println("Clicked on Add Harvesting");
            ...
            System.out.println("✅ Done filling all fields in Harvesting form!");
            ...
            try {
                ...
                submitButton.click();
                System.out.println("✅ Submitted the Harvesting form!");
            } catch (Exception e) {
                System.out.println("❌ Could not find/click Submit button: " + e.getMessage());
            }
