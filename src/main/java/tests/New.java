                        ...
                        for (MobileElement field : fields) {
                            ...
                            if (!filledFields.contains(fieldId)) {
                                try {
                                    ...
                                    String hintText = "";
                                    try {
                                        hintText = field.getAttribute("hint");
                                    } catch (Exception ignored) {}

                                    if (hintText.toLowerCase().contains("dome")) {
                                        field.sendKeys("Dome" + record); // Alphabets
                                    } else {
                                        field.sendKeys(String.valueOf(globalInputCounter)); // Positive integer
                                    }
